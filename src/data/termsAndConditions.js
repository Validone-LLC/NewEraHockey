export const termsAndConditions = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        'Cancellations made more than 48 hours before a scheduled session may be eligible for rescheduling or credit toward future sessions.',
        'Cancellations made less than 48 hours before a session are non-refundable.',
        'New Era Hockey reserves the right to cancel sessions due to weather, facility closures, or other circumstances beyond our control. Affected participants will be notified promptly and offered rescheduling options.',
        'No-shows forfeit the session fee and training time.',
      ],
    },
    {
      id: 'liability',
      ...
      content: [
        ...
        'Participants and guardians (for minors) agree to release New Era Hockey, its coaches, employees, and affiliates from liability for injuries or damages occurring during training sessions, except in cases of gross negligence.',
