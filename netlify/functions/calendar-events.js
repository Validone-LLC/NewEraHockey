...
/**
 * Netlify Function: Fetch Google Calendar Events with Workload Identity Federation
 *
  ...
  try {
    ...
    const auth = new GoogleAuth({
      ...
      credentials: {
        ...
        credential_source: {
          // Netlify provides OIDC token via environment
          environment_id: 'netlify',
          format: {
            type: 'text',
          },
          // Netlify JWT token from context
